...
public class QuicksortTest
{
   ...
   public void testEmpty() {
             ...
             QS.normalQuickSort(array1, 0, array1.length - 1);
             assertArrayEquals(array1,array2);
             QS.randomizedQuickSort(array1, 0, array1.length - 1);
             assertArrayEquals(array1,array2);
   }   
   ...
   // sort using Java's inbuilt sorting method
        ...
        // run QS2()
        QS.randomizedQuickSort(array2, 0, array2.length - 1);
        assertArrayEquals(array1,array3);
   ...
   public void testQS1Timing()
   {
      ...
      QS.normalQuickSort(array2, 0, array2.length - 1);
      end = System.currentTimeMillis();
      elapsed = end - start;
      System.out.println("QS1 time to sort 1000000 elements in ms:"+ elapsed);
      
      start = System.currentTimeMillis();
      QS.normalQuickSort(array3, 0, array3.length - 1);
      end = System.currentTimeMillis();
      elapsed = end - start;
   ...
   public void testQS2Timing()
   {
      ...
      start = System.currentTimeMillis();
      QS.randomizedQuickSort(array3, 0, array3.length - 1);
      end = System.currentTimeMillis();
      elapsed = end - start;
